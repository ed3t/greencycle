...
if(checkloggedin()) {
    ...
    $pagging = pagenav($total_item,$_GET['page'],$limit,$config['site_url'].'hidden-ads.php');
    // Output to template
    $page = new HtmlTemplate ('templates/' . $config['tpl_name'] . '/ad-hidden.html');
    $page->SetParameter ('OVERALL_HEADER', create_header($config,$lang,$lang['HIDDEN-ADS'],$link));
