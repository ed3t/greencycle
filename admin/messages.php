                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <tr class="mail-contnet ajax-item-listing" data-item-id="<?php echo $id ?>">
                                    ...
                                    <td class="text-nowrap">
                                        ...
                                        <a href="message_delete.php?id=<?php echo $id;?>" data-toggle="tooltip" data-original-title="Delete Message" class="action item-js-delete" data-ajax-action="deleteads"> <i class="ti-close text-danger"></i> </a>
                                    </td>
                                </tr>
                            <?php }?>
