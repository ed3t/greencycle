                    ...
                    <form method="post" name="f1" id="f1">
                        ...
                        <div class="table-responsive" id="js-table-list">
                            <table id="myTable" class="table table-striped">
                                ...
                                <tbody>
                                <?php
                                $getItem = get_items($config,false,"pending");
                                    ...
                                    <tr class="mail-contnet ajax-item-listing" data-item-id="<?php echo $ad_id ?>">
                                        ...
                                        <td class="text-nowrap text-center">
                                            ...
                                            <?php if($ad_status == "pending"){
                                                ?>
                                                <a href="javacript:void(0)"  data-toggle="tooltip" data-original-title="Approve"  class="action item-approve" data-ajax-action="approveitem"><i class="ti-check text-success"></i></a>
                                            <?php } ?>

                                            <a href="javacript:void(0)" data-toggle="tooltip" data-original-title="Delete" class="action item-js-delete" data-ajax-action="deleteads"><i class="ti-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
