        ...
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Re-Submit Ads List</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <form method="post" name="f1" id="f1">
                        <div>
                            <div class="pull-left"><h3 class="box-title">Re-Submit Ads List</h3></div>
                            <div class="pull-right">
                                <p class="text-muted">
                                    <button data-ajax-response="deletemarked" data-ajax-action="deleteResubmitItem" class="btn btn-danger waves-effect waves-light m-r-10"><i class="fa fa-trash-o"></i> Delete Marked</button>
                                </p>
                            </div>
                            <div class="clear"></div>
                        </div>
                        ...
                        <div class="table-responsive" id="js-table-list">
                            <table id="myTable" class="table table-striped">
                                ...
                                <tbody>
                                <?php
                                $getItem = get_resubmited_items($config);
                                foreach ($getItem as $ads) {
                                    ...
                                    $status = '<span class="label label-success">Re-Submit</span>';
                                    ?>
                                    ...
                                    <tr class="mail-contnet ajax-item-listing" data-item-id="<?php echo $ad_id ?>">
                                        ...
                                        <td class="txt-oflo">
                                            ...
                                            <div class="user-img"> <img src="../storage/products/screenshot/<?php echo $ad_pic; ?>" alt="<?php echo $ad_author ?>" style="width:auto; max-height:100px;max-width: 100px;"></div>
                                        </td>
                                        <td>
                                            <a href="post_detail.php?id=<?php echo $ad_id;?>&resubmit=1" target="_blank"><?php echo $ad_title; ?> </a>
                                        </td>
                                        <td>
                                        ...
                                        <td><span  data-toggle="tooltip" data-original-title="<?php echo $ad_location ?>">
                                        <?php
                                        ...
                                        <td class="text-nowrap text-center">
                                            ...
                                            <a href="post_detail.php?id=<?php echo $ad_id;?>&resubmit=1"  data-toggle="tooltip" data-original-title="View"  class="action" target="_blank"><i class="ti-eye"></i></a>
                                            <a href="javacript:void(0)"  data-toggle="tooltip" data-original-title="Approve"  class="action item-approve" data-ajax-action="approveResubmitItem"><i class="ti-check"></i></a>


                                            <a href="javacript:void(0)" data-toggle="tooltip" data-original-title="Reject" class="action item-js-delete" data-ajax-action="deleteResubmitItem"><i class="ti-close"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
