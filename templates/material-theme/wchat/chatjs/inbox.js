...
var originalTitle;
var blinkOrder = 0;
var audioogg = new Audio(siteurl+'templates/'+template_name+'/wchat/audio/chat.ogg');
var audiomp3 = new Audio(siteurl+'templates/'+template_name+'/wchat/audio/chat.mp3');
...
function updateSeenmsg(chatuser) {
    $.post(siteurl+"plugins/wchat/chat.php?action=updateSeenmsg", {chatuser: chatuser} , function(data){
    });
...
function createChatBox(chatboxtitle,toid,img,status,minimizeChatBox) {
    ...
    get_all_msg(siteurl+"plugins/wchat/chat.php?page=1&action=get_all_msg&client="+chatboxtitle);
...
function startChatSession(){
    ...
    $.ajax({
        url: siteurl+"plugins/wchat/chat.php?action=startchatsession",
        cache: false,
        dataType: "json",
        success: function(data) {
...
function checkChatBoxInputKey(event,chatboxtextarea,chatboxtitle,toid,img,send) {
    ...
    if((event.keyCode == 13 && event.shiftKey == 0) || (send == 1))  {
        ...
        if (message != '') {
            $.post(siteurl+"plugins/wchat/chat.php?action=sendchat", {to: chatboxtitle, toid: toid, message: message} , function(data){
...
function chatHeartbeat(TOusername){
    ...
    $.ajax({
        url: siteurl+"plugins/wchat/chat.php?action=chatheartbeat&fromuname="+TOusername,
        cache: false,
        dataType: "json",
        success: function(data) {
...
function chatfrindList(){
    $.ajax({
        url: siteurl + "plugins/wchat/chat.php?action=chatfrindList",
        cache: false,
        type: "POST",
        success: function (data) {
...
function checkMsgSeen(id,chatuser){
    $.ajax({
        url: siteurl + "plugins/wchat/chat.php?action=checkMsgSeen&msgid="+id+"&uname="+chatuser,
        cache: false,
        type: "POST",
        success: function (data) {
            if(data == 1)
...
function userProfile(username){
    $.ajax({
        url: siteurl + "plugins/wchat/chat.php?action=userProfile&uname="+username,
        cache: false,
        type: "POST",
        success: function (data) {
...
function lastseen(username){
    $.ajax({
        url: siteurl + "plugins/wchat/chat.php?action=lastseen&uname="+username,
        cache: false,
        type: "POST",
        success: function (data) {
...
function savechat(mail){
    ...
    $.ajax({
        url: siteurl + "plugins/wchat/chat.php?action=savechat&uname="+username+"&mail="+mail,
        cache: false,
        type: "POST",
        success: function (data) {
            if(mail == false){
...
$(document).ready(function(){
    ...
    $('.search_bg').on('keyup', function(){
        ...
        else
        {
            ...
            $.ajax({
                type: "POST",
                url: siteurl+"plugins/wchat/chat.php?action=searchUser",
                data: dataString,
                cache: false,
                success: function(data)
                {
